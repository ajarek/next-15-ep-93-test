  ...
  return (
    <div className=' min-h-screen flex flex-col justify-start items-center gap-4 '>
      ...
      <div className='flex items-center gap-4'>
        ...
        <Link
          href={`/dashboard/notebook/content/${params.id}`}
          className='h-9 px-4 py-2 rounded-md bg-green-500 text-white text-sm shadow-xs hover:bg-green-500/90'
        >
          Add Content
        </Link>
      </div>
            ...
            <div className='grid w-full items-center gap-4'>
              <div className='flex flex-col space-y-1.5'>
                ...
                <Input
                  id='name'
                  name='name'
                  defaultValue={notebookData.name}
                />
              </div>
              ...
              <div className='flex flex-col space-y-1.5'>
                ...
                <Select
                  name='column'
                  defaultValue={notebookData.column}
                >
                  <SelectTrigger>
              ...
              <div className='flex flex-col space-y-1.5'>
                ...
                <Textarea
                  id='content'
                  name='content'
                  defaultValue={notebookData.content}
                />
              </div>
            </div>
